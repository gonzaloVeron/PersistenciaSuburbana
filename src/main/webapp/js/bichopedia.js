  ...
  render: function() {
    return (
      <div className="especieFullBox">
        ...
        <div className="col col-sm-6">
          <div className="especieNombre">{this.state.data.nombre}</div>
          <dl>
...
var EspecieBox = React.createClass({
  ...
  render: function() {
    return (
      <div>
        <div className="especieBox col col-5 col-xs-4 col-sm-3 col-md-3 col-lg-2 col-xl-2" onClick={this.open}>
          <img src={this.props.data.urlFoto} />
          {this.props.data.nombre}
        </div>
        <ReactBootstrap.Modal show={this.state.showModal} onHide={this.close} dialogClassName="especieFullBoxModal modal-lg">
  ...
  render: function() {
    ...
    return (
      <div className="bichoPedia">
        <h1 className="title">Bichopedia - Especies</h1>
